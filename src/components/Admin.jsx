  ...
  const handleSubmit = async (e) => {
    ...
    if (editandoId) {
      ...
      await supabase.from("productos").insert([
        { titulo, precio, imagen_url: imageUrl },
      ]);
    }
...
>
  ...
  <div className="flex flex-col gap-2">
    ...
    <label
      className="group cursor-pointer border-2 border-dashed border-gray-300 hover:border-fuchsia-400 transition rounded-2xl p-6 flex flex-col items-center justify-center gap-3 bg-gray-50 hover:bg-fuchsia-50"
    >
