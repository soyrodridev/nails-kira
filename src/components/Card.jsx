  ...
  return (
    <>
      ...
      >
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="w-7 h-7 rounded-full bg-pink-100 hover:bg-pink-200 transition cursor-pointer"
                        >
                          -
                        </button>
                        ...
                        <button
                          ...
                          className="w-7 h-7 rounded-full bg-pink-500 text-white hover:bg-pink-600 transition cursor-pointer"
                        >
                          +
                        </button>
                      </div>
        ...
        {/* Footer del Carrito */}
        {cartItems.length > 0 && (
          <div className="p-5 border-t border-pink-100 bg-white pb-[calc(env(safe-area-inset-bottom)+20px)]">
            ...
            <a
              href="/checkout"
              onClick={onClose}
              className="block w-full text-center bg-pink-500 hover:bg-pink-600 text-white py-3 rounded-xl font-medium transition cursor-pointer"
            >
              Finalizar compra
            </a>
          </div>
