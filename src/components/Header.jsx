      ...
      <header className="w-full bg-pink-50/80 backdrop-blur-md border-pink-100 border-b sticky top-0 z-50">
        <nav className="max-w-7xl mx-auto relative flex items-center justify-between h-20 px-6">
          ...
          <ul className="hidden md:flex items-center gap-10 absolute left-1/2 -translate-x-1/2">
            <li>
              <a
                href="/"
                className="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-pink-600 uppercase tracking-wider transition"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
          ...
          <div className="flex items-center gap-6 z-20">
            ...
            <div className="relative flex items-center justify-end w-48">
              <input
                ...
                className={`bg-gray-50 border border-gray-200 rounded-full py-1 pl-4 pr-10 text-sm transition-all duration-300 outline-none focus:border-pink-500 ${
                  searchOpen
                    ? "w-full opacity-100"
              ...
              <button
                ...
                className="absolute right-0 hover:text-pink-600 transition p-1"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            <div className="relative hidden md:block">
              {user ? (
                <button
                  ...
                  className="text-sm font-medium text-gray-800 hover:text-pink-600 transition uppercase tracking-wider"
                >
                  {user.username}
                </button>
              ) : (
              ...
              {userMenuOpen && (
                <div className="absolute right-0 mt-3 w-48 bg-white rounded-lg shadow-xl border border-pink-100 py-2 z-50">
                  <a
                    href="/cliente"
                    className="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:bg-pink-50"
                  >
                    Ver Perfil
                  </a>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-4 py-2 text-sm text-red-500 hover:bg-pink-50"
                  >
                    Cerrar sesión
                  </button>
                </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 p-6 space-y-4 shadow-lg">
            ...
            <a href="/acerca" className="flex items-center gap-3 text-gray-600">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
            ...
            <div className="border-t pt-4">
              {user ? (
                <>
                  ...
                  <a
                    href="/cliente"
                    className="block py-2 text-gray-600 flex items-center gap-3"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
                  ...
                  <button
                    onClick={handleLogout}
                    className="block py-2 text-red-500 flex items-center gap-3"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
                ...
                <a
                  href="/login"
                  className="block py-2 text-gray-800 font-medium flex items-center gap-3"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
