    ...
    <div className="flex flex-col items-center w-full animate-in fade-in">
      ...
      {pagoRealizado ? (
        ...
        <>
          ...
          <h2 className="mt-8 text-3xl font-extrabold text-green-600">
            ¡Pago realizado!
          </h2>
          ...
          <div className="w-full h-2 rounded-full bg-green-100 mt-8 overflow-hidden">
        ...
        <div className="flex flex-col items-center">
          ...
          <svg
            className="animate-spin w-12 h-12 text-pink-500"
            viewBox="0 0 24 24"
            fill="none"
          >
            <circle
          ...
          <p className="mt-8 font-bold text-pink-600">
            Generando QR...
          </p>
        ...
        <>
          ...
          <svg
            className="animate-spin w-8 h-8 text-pink-500 mt-8"
            viewBox="0 0 24 24"
            fill="none"
          >
            <circle
